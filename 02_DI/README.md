...
- 프로그램을 구동하는 데 필요한 객체에 대한 생성, 변경 등의 관리를 개발자가 아닌 컨테이너에서 직접 관리하는 것을 말한다.
...
- 개발자가 직접 객체를 생성할 수 있지만 해당 권한을 컨테이너의 맡김으로써 소스 코드 구현의 시간을 단축할 수 있다.
...
```xml
<beans>
    <bean id="student" class="com.kh.model.vo.Student"></bean>
</bean>
```
